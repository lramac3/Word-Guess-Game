...
var correct = 0;
var key = ["cincinnati", "sanantonio", "tampabayrowdies", "saintlouis", "charleston", "rochesterrhinos", "phoenixrising", "richmond", "nashville", "northcarolina", "louisville", "newyorkredbulls", "penn", "pittsburg", "tulsa", "lasvegas", "ottawa", "reno", "sacramento", "orangecounty", "okcenergy", "swopeparkrangers", "riograndevalley", "realmonarchs", "indyeleven", "coloradosprings", "portlandtimbers", "charlotte", "toronto", "lagalaxy", "bethlehem", "seattlesounders", "atlantaunited", "fresno", "orlandocity", "charlotte", "wilmington", "loudoun", "austinbold", "daytondutch", "vancouver", "montreal", "newyork", "tampabay", "antigua", "sevilla", "austin", "phoenix"];
var guess = [];
var chances = 6;
var wrong = 0;
var wrongGuess = [];
